...
/** Input for the createSong mutation */
export interface CreateSongInput {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
  /** Set connections between the song and genres */
  genres?: InputMaybe<SongGenresInput>;
  ...
  /** The slug of the object */
  slug?: InputMaybe<Scalars["String"]>;
  songTitle?: InputMaybe<Scalars["String"]>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** The title of the object */
  title?: InputMaybe<Scalars["String"]>;
...
/** Input for the deleteAlbum mutation */
...
/** Input for the deleteSong mutation */
...
/** Arguments for filtering the GenreToSongConnection connection */
export interface GenreToSongConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the RootQueryToAlbumConnection connection */
export interface RootQueryToAlbumConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the RootQueryToSongConnection connection */
export interface RootQueryToSongConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Set relationships between the song to genres */
export interface SongGenresInput {
  ...
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<SongGenresNodeInput>>>;
}

/** List of genres to connect the song to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface SongGenresNodeInput {
  ...
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the genre. If present, this will be used to connect to the song. If no existing genre exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
...
/** Arguments for filtering the SongToGenreConnection connection */
export interface SongToGenreConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the SongToTermNodeConnection connection */
export interface SongToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Input for the updateAlbum mutation */
...
/** Input for the updateSong mutation */
...
/** Arguments for filtering the UserToAlbumConnection connection */
export interface UserToAlbumConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the UserToSongConnection connection */
export interface UserToSongConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const generatedSchema = {
  Album: {
    ...
    preview: { __type: "AlbumToPreviewConnectionEdge" },
    ...
    trackList: {
      __type: "AlbumToSongConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    uri: { __type: "String" },
  },
  AlbumToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Album" },
  },
  AlbumToSongConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[AlbumToSongConnectionEdge]" },
    nodes: { __type: "[Song]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  AlbumToSongConnectionEdge: {
    __typename: { __type: "String!" },
  ...
  CreateSongInput: {
    ...
    clientMutationId: { __type: "String" },
    date: { __type: "String" },
    genres: { __type: "SongGenresInput" },
    length: { __type: "String" },
    lyrics: { __type: "String" },
    menuOrder: { __type: "Int" },
    password: { __type: "String" },
    slug: { __type: "String" },
    songTitle: { __type: "String" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  CreateSongPayload: {
  ...
  Genre: {
    ...
    slug: { __type: "String" },
    songs: {
      __type: "GenreToSongConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "GenreToSongConnectionWhereArgs",
      },
    },
  ...
  GenreToSongConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[GenreToSongConnectionEdge]" },
    nodes: { __type: "[Song]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  GenreToSongConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Song" },
  },
  GenreToSongConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToAlbumConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToAlbumConnectionEdge]" },
    nodes: { __type: "[Album]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToAlbumConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Album" },
  },
  RootQueryToAlbumConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToSongConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToSongConnectionEdge]" },
    nodes: { __type: "[Song]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToSongConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Song" },
  },
  RootQueryToSongConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  Song: {
    ...
    genres: {
      __type: "SongToGenreConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "SongToGenreConnectionWhereArgs",
      },
    },
    guid: { __type: "String" },
    id: { __type: "ID!" },
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "SongToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    songId: { __type: "Int!" },
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "SongToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "SongToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  SongGenresInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[SongGenresNodeInput]" },
  },
  SongGenresNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
  ...
  SongToAlbumConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SongToAlbumConnectionEdge]" },
    nodes: { __type: "[Album]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  SongToAlbumConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Album" },
  },
  SongToGenreConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SongToGenreConnectionEdge]" },
    nodes: { __type: "[Genre]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  SongToGenreConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Genre" },
  },
  SongToGenreConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  SongToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Song" },
  },
  SongToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[SongToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  SongToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  SongToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  User: {
    __typename: { __type: "String!" },
    albums: {
      __type: "UserToAlbumConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToAlbumConnectionWhereArgs",
      },
    },
    avatar: {
      __type: "Avatar",
    ...
    slug: { __type: "String" },
    songs: {
      __type: "UserToSongConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToSongConnectionWhereArgs",
      },
    },
    templates: { __type: "[String]" },
    uri: { __type: "String" },
  ...
  UserToAlbumConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToAlbumConnectionEdge]" },
    nodes: { __type: "[Album]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToAlbumConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Album" },
  },
  UserToAlbumConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToSongConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToSongConnectionEdge]" },
    nodes: { __type: "[Song]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToSongConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Song" },
  },
  UserToSongConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    __typename: { __type: "String!" },
    createAlbum: {
      __type: "CreateAlbumPayload",
      __args: { input: "CreateAlbumInput!" },
    },
    createCategory: {
    ...
    createGenre: {
      __type: "CreateGenrePayload",
      __args: { input: "CreateGenreInput!" },
    },
    createMediaItem: {
    ...
    createSong: {
      __type: "CreateSongPayload",
      __args: { input: "CreateSongInput!" },
    },
    createTag: {
    ...
    deleteAlbum: {
      __type: "DeleteAlbumPayload",
      __args: { input: "DeleteAlbumInput!" },
    },
    deleteCategory: {
    ...
    deleteGenre: {
      __type: "DeleteGenrePayload",
      __args: { input: "DeleteGenreInput!" },
    },
    deleteMediaItem: {
    ...
    deleteSong: {
      __type: "DeleteSongPayload",
      __args: { input: "DeleteSongInput!" },
    },
    deleteTag: {
    ...
    updateAlbum: {
      __type: "UpdateAlbumPayload",
      __args: { input: "UpdateAlbumInput!" },
    },
    updateCategory: {
    ...
    updateGenre: {
      __type: "UpdateGenrePayload",
      __args: { input: "UpdateGenreInput!" },
    },
    updateMediaItem: {
    ...
    updateSong: {
      __type: "UpdateSongPayload",
      __args: { input: "UpdateSongInput!" },
    },
    updateTag: {
  ...
  query: {
    ...
    album: {
      __type: "Album",
      __args: { asPreview: "Boolean", id: "ID!", idType: "AlbumIdType" },
    },
    albumBy: {
      __type: "Album",
      __args: { albumId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    albums: {
      __type: "RootQueryToAlbumConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToAlbumConnectionWhereArgs",
      },
    },
    allSettings: { __type: "Settings" },
    atlasContentModelerSettingsSettings: {
    ...
    song: {
      __type: "Song",
      __args: { asPreview: "Boolean", id: "ID!", idType: "SongIdType" },
    },
    songBy: {
      __type: "Song",
      __args: { id: "ID", slug: "String", songId: "Int", uri: "String" },
    },
    songs: {
      __type: "RootQueryToSongConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToSongConnectionWhereArgs",
      },
    },
  ...
  subscription: {},
  [SchemaUnionsKey]: {
    ContentNode: ["Album", "MediaItem", "Page", "Post", "Song"],
    DatabaseIdentifier: [
      "Album",
      "Category",
      "Comment",
    ...
    NodeWithAuthor: ["Album", "MediaItem", "Page", "Post", "Song"],
    NodeWithTemplate: ["Album", "MediaItem", "Page", "Post", "Song"],
    NodeWithTitle: ["Album", "MediaItem", "Page", "Post", "Song"],
    UniformResourceIdentifiable: [
      "Album",
      "Category",
      "ContentType",
    ...
    MenuItemLinkable: ["Category", "Genre", "Page", "Post", "Tag"],
    ...
    MenuItemObjectUnion: ["Category", "Genre", "Page", "Post", "Tag"],
...
export interface Album {
   ...
   */
  albumId: ScalarsEnums["Int"];
  albumTitle?: Maybe<ScalarsEnums["String"]>;
  /**
  ...
  /**
   * The globally unique identifier of the album object.
   */
  id: ScalarsEnums["ID"];
  /**
  ...
  /**
   * Connection between the album type and the album type
   */
  preview?: Maybe<AlbumToPreviewConnectionEdge>;
  /**
  ...
  /**
   * Connection between the album type and the song type
   */
  trackList: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
 ...
 * Connection between the album type and the album type
 */
export interface AlbumToPreviewConnectionEdge {
  __typename?: "AlbumToPreviewConnectionEdge";
  /**
 ...
 * Connection between the album type and the song type
 */
export interface AlbumToSongConnection {
  __typename?: "AlbumToSongConnection";
  /**
   * Edges for the AlbumToSongConnection connection
   */
  edges?: Maybe<Array<Maybe<AlbumToSongConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Song>>>;
  /**
 ...
 */
export interface AlbumToSongConnectionEdge {
  __typename?: "AlbumToSongConnectionEdge";
  /**
...
export interface ContentNode {
  __typename?: "Album" | "MediaItem" | "Page" | "Post" | "Song";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
/**
 * The payload for the createAlbum mutation
 */
...
/**
 * The payload for the createSong mutation
 */
...
/**
 * The payload for the deleteAlbum mutation
 */
...
/**
 * The payload for the deleteSong mutation
 */
...
export interface Genre {
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the genre type and the song type
   */
  songs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<GenreToSongConnectionWhereArgs>;
  }) => Maybe<GenreToSongConnection>;
  /**
 ...
 * Connection between the genre type and the song type
 */
export interface GenreToSongConnection {
  __typename?: "GenreToSongConnection";
  /**
   * Edges for the GenreToSongConnection connection
   */
  edges?: Maybe<Array<Maybe<GenreToSongConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Song>>>;
 ...
 * An edge in a connection
 */
export interface GenreToSongConnectionEdge {
  __typename?: "GenreToSongConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface MenuItemLinkable {
  __typename?: "Category" | "Genre" | "Page" | "Post" | "Tag";
  /**
   * The unique resource identifier path
   */
  databaseId: ScalarsEnums["Int"];
...
/**
 * Connection between the RootQuery type and the album type
 */
export interface RootQueryToAlbumConnection {
  __typename?: "RootQueryToAlbumConnection";
  /**
   * Edges for the RootQueryToAlbumConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToAlbumConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface RootQueryToAlbumConnectionEdge {
  __typename?: "RootQueryToAlbumConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the song type
 */
export interface RootQueryToSongConnection {
  __typename?: "RootQueryToSongConnection";
  /**
   * Edges for the RootQueryToSongConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToSongConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Song>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToSongConnectionEdge {
  __typename?: "RootQueryToSongConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Song {
  __typename?: "Song";
  /**
   * Connection between the song type and the album type
   */
  album: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
  ...
  /**
   * Connection between the song type and the genre type
   */
  genres: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<SongToGenreConnectionWhereArgs>;
  }) => Maybe<SongToGenreConnection>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the song object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
   ...
   */
  link?: Maybe<ScalarsEnums["String"]>;
  lyrics?: Maybe<ScalarsEnums["String"]>;
  /**
   * The local modified time for a post. If a post was recently updated the modified field will change to match the corresponding time.
   */
  modified?: Maybe<ScalarsEnums["String"]>;
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the song type and the song type
   */
  preview?: Maybe<SongToPreviewConnectionEdge>;
  /**
   * The database id of the preview node
   */
  previewRevisionDatabaseId?: Maybe<ScalarsEnums["Int"]>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  songId: ScalarsEnums["Int"];
  songTitle?: Maybe<ScalarsEnums["String"]>;
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums["String"]>;
  ...
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * Connection between the song type and the TermNode type
   */
  terms: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<SongToTermNodeConnectionWhereArgs>;
  }) => Maybe<SongToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
 ...
 * Connection between the song type and the album type
 */
export interface SongToAlbumConnection {
  __typename?: "SongToAlbumConnection";
  /**
   * Edges for the SongToAlbumConnection connection
   */
  edges?: Maybe<Array<Maybe<SongToAlbumConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Album>>>;
 ...
 * An edge in a connection
 */
export interface SongToAlbumConnectionEdge {
  __typename?: "SongToAlbumConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the song type and the genre type
 */
export interface SongToGenreConnection {
  __typename?: "SongToGenreConnection";
  /**
   * Edges for the SongToGenreConnection connection
   */
  edges?: Maybe<Array<Maybe<SongToGenreConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Genre>>>;
 ...
 * An edge in a connection
 */
export interface SongToGenreConnectionEdge {
  __typename?: "SongToGenreConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the song type and the song type
 */
export interface SongToPreviewConnectionEdge {
  __typename?: "SongToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Song>;
 ...
 * Connection between the song type and the TermNode type
 */
export interface SongToTermNodeConnection {
  __typename?: "SongToTermNodeConnection";
  /**
   * Edges for the SongToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<SongToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<TermNode>>>;
 ...
 * An edge in a connection
 */
export interface SongToTermNodeConnectionEdge {
  __typename?: "SongToTermNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the updateAlbum mutation
 */
...
/**
 * The payload for the updateSong mutation
 */
...
export interface User {
  __typename?: "User";
  /**
   * Connection between the User type and the album type
   */
  albums: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToAlbumConnectionWhereArgs>;
  }) => Maybe<UserToAlbumConnection>;
  /**
   * Avatar object for user. The avatar object can be retrieved in different sizes by specifying the size argument.
   */
  avatar: (args?: {
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the User type and the song type
   */
  songs: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToSongConnectionWhereArgs>;
  }) => Maybe<UserToSongConnection>;
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The unique resource identifier path
   */
 ...
 * Connection between the User type and the album type
 */
export interface UserToAlbumConnection {
  __typename?: "UserToAlbumConnection";
  /**
   * Edges for the UserToAlbumConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToAlbumConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Album>>>;
 ...
 * An edge in a connection
 */
export interface UserToAlbumConnectionEdge {
  __typename?: "UserToAlbumConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the User type and the song type
 */
export interface UserToSongConnection {
  __typename?: "UserToSongConnection";
  /**
   * Edges for the UserToSongConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToSongConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Song>>>;
 ...
 * An edge in a connection
 */
export interface UserToSongConnectionEdge {
  __typename?: "UserToSongConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  __typename?: "Mutation";
  createAlbum: (args: { input: CreateAlbumInput }) => Maybe<CreateAlbumPayload>;
  createCategory: (args: {
  ...
  createSong: (args: { input: CreateSongInput }) => Maybe<CreateSongPayload>;
  createTag: (args: { input: CreateTagInput }) => Maybe<CreateTagPayload>;
  createUser: (args: { input: CreateUserInput }) => Maybe<CreateUserPayload>;
  deleteAlbum: (args: { input: DeleteAlbumInput }) => Maybe<DeleteAlbumPayload>;
  deleteCategory: (args: {
  ...
  deleteSong: (args: { input: DeleteSongInput }) => Maybe<DeleteSongPayload>;
  ...
  updateAlbum: (args: { input: UpdateAlbumInput }) => Maybe<UpdateAlbumPayload>;
  updateCategory: (args: {
  ...
  updateSong: (args: { input: UpdateSongInput }) => Maybe<UpdateSongPayload>;
...
export interface Query {
  ...
  albums: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToAlbumConnectionWhereArgs>;
  }) => Maybe<RootQueryToAlbumConnection>;
  allSettings?: Maybe<Settings>;
  atlasContentModelerSettingsSettings?: Maybe<AtlasContentModelerSettingsSettings>;
  categories: (args?: {
    after?: Maybe<Scalars["String"]>;
  ...
  songs: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToSongConnectionWhereArgs>;
  }) => Maybe<RootQueryToSongConnection>;
...
export interface SchemaObjectTypes {
  Album: Album;
  AlbumToPreviewConnectionEdge: AlbumToPreviewConnectionEdge;
  AlbumToSongConnection: AlbumToSongConnection;
  AlbumToSongConnectionEdge: AlbumToSongConnectionEdge;
  ...
  CreateAlbumPayload: CreateAlbumPayload;
  ...
  DeleteSongPayload: DeleteSongPayload;
  ...
  GenreToSongConnection: GenreToSongConnection;
  GenreToSongConnectionEdge: GenreToSongConnectionEdge;
  ...
  RootQueryToAlbumConnection: RootQueryToAlbumConnection;
  RootQueryToAlbumConnectionEdge: RootQueryToAlbumConnectionEdge;
  ...
  RootQueryToSongConnection: RootQueryToSongConnection;
  RootQueryToSongConnectionEdge: RootQueryToSongConnectionEdge;
  ...
  Settings: Settings;
  Song: Song;
  SongToAlbumConnection: SongToAlbumConnection;
  SongToAlbumConnectionEdge: SongToAlbumConnectionEdge;
  SongToGenreConnection: SongToGenreConnection;
  SongToGenreConnectionEdge: SongToGenreConnectionEdge;
  SongToPreviewConnectionEdge: SongToPreviewConnectionEdge;
  SongToTermNodeConnection: SongToTermNodeConnection;
  SongToTermNodeConnectionEdge: SongToTermNodeConnectionEdge;
  ...
  Theme: Theme;
  UpdateAlbumPayload: UpdateAlbumPayload;
  ...
  UpdateSongPayload: UpdateSongPayload;
  UpdateTagPayload: UpdateTagPayload;
  UpdateUserPayload: UpdateUserPayload;
  User: User;
  UserRole: UserRole;
  UserToAlbumConnection: UserToAlbumConnection;
  UserToAlbumConnectionEdge: UserToAlbumConnectionEdge;
  ...
  UserToSongConnection: UserToSongConnection;
  UserToSongConnectionEdge: UserToSongConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  AlbumIdType: AlbumIdType | undefined;
  ...
  SongIdType: SongIdType | undefined;
